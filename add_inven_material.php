<?php 
include('crud_conn_files/add_inven_material_conn.php');
include ('session.php');
?> 
...
<head>
	...
	<title>CTG Limited: Add Inventory</title>
</head>
<body>
	...
	<form method="post" action="add_inven_material.php">
      ...
      <div class="material-input">
        ...
        <input type="material" name="material_title" autocomplete="off" value="<?php echo $material_title; ?>">
    ...
    <script src="js_scripts/script.js"></script>
		...
		<div class="input-group">
			...
			<input type="number" name="avl_qty" value="<?php echo $avl_qty; ?>">
		</div>
		
		<div class="input-group">
			<p>
			<button type="submit" class="btn" name="add_inven">Add</button>	
