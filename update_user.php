<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        $query = mysqli_query($conn, "UPDATE ctg_users SET fullname='$fullname', email='$email', username='$username' WHERE id='$id'");
        if($query){
...
<head>
    ...
    <title>CTG Limited: Update User</title>
</head>
<body>
    ...
    <form method="post">
        ...
        include ('crud_conn_files/conn.php');
            $id = $_GET['updateid'];
            $query = mysqli_query($conn, "SELECT * FROM ctg_users WHERE id='$id'");
            while ($row = mysqli_fetch_array($query)) {
        ?>
        <div class="input-group">
            <label>Full Name</label>
            <input type="fullname" value="<?php echo $row["fullname"]?>" name="fullname" >
        </div>
        ...
        <div class="input-group">
            ...
            <button ty></button><a href="users.php" value="back"class="btn">Back</a>
            </p>
        </div>
    </form>
    <div class="footer">
